...
function kad_split_content_widget() {
        ...
        $this->__construct('virtue_split_content_widget', __('Virtue: Split Content', 'virtue'), $widget_ops);
        $this->alt_option_name = 'virtue_split_content_widget';
    }
    ...
    function update($new_instance, $old_instance) {
      ...
      function flush_widget_cache() {
        wp_cache_delete('virtue_split_content_widget', 'widget');
      }
